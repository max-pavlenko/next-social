...
import { invertBool, validationSchemaPassword } from '../utils/helpers';
          ...
          <Container>
             <Formik
              ...
              validationSchema = {Yup.object({
                 newPassword: validationSchemaPassword('New'),
                 confirmedPassword: validationSchemaPassword('Confirmed'),
              })}
