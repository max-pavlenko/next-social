...
import DefaultMenuItems from '../../../shared/components/widgets/DefaultMenuItems';

const MenuAccountAvatar = observer(({ styles = {} }: { styles?: CSSProperties }) => {
...
export default MenuAccountAvatar;
