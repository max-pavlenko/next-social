...
const Draggable: FC<PropsWithChildren<Props>> = ({ children }) => {
       ...
       ref={draggableRef} style={{
        ...
        <div style={{ position: 'relative' }}>
           <div className={styles.dragContent} style={{
              resize: isCollapsed ? 'initial' : 'both',
              overflow: 'auto',
              ...
              minWidth: isCollapsed ? undefined : MINIMUM_RESIZED_SIZES.width,
              minHeight: isCollapsed ? undefined : MINIMUM_RESIZED_SIZES.height,
              ...
              {!isCollapsed && <a onClick={() => setClickCountForMovableArea(prevState => ++prevState)}
                                  style={{
                                     ...
                                     right: clickCountForMovableArea % 2 === 0 ? 20 : 10, bottom: clickCountForMovableArea % 2 === 0 ? 0 : 3,
                                  }}>
           ...
           <div style={{ maxHeight: clickCountForMovableArea % 2 === 0 ? 0 : 100, maxWidth: isCollapsed ? 25 : 1000 }}
