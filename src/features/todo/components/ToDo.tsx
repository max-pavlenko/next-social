...
const ToDo: FC<Props> = ({ isChecked, text, id, onCheckedChange, onTodoDelete }) => {
        ...
        <motion.div key={id} variants={variants} initial="enter" animate="enter" exit="exit"
           ...
           <FormGroup>
              <FormControlLabel control={
                 <Checkbox sx={{ width: 30, height: 30 }} size="small" color="primary"
                 ...
                 <div ref={todoRef} style={{
                    ...
                    {text}
                    <div className="lineTrough" style={{ maxWidth: isChecked ? todoRef.current?.getBoundingClientRect().width || '500px' : 0 }}></div>
                 </div>
              } />
           </FormGroup>
